...
import { client } from '../db/config/database.js';
...
// NOTE: getPulseAnalysis has been extracted to:
//   services/pulse-engine/api/pulseController.js
// It is routed via routes/ai.js which imports it from the pulse-engine service.
...
// 11. Pulse Sandbox Endpoint — MOVED
// getPulseAnalysis has been extracted to:
//   services/pulse-engine/api/pulseController.js
// The /api/ai/pulse route in routes/ai.js now imports from there.
//
// The following helper functions have also moved:
//   - runPythonAnalyzer()          → pulseController.js
//   - fallbackJSAnalyzer()         → pulseController.js
//   - generateFallbackClinicalReport() → pulseController.js
